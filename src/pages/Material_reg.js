        ...
        const handleSubmit = async () => {
            try {
                ...
                if (response.data.success) {
                    ...
                    setCategories(response.data.data); // Assuming response.data.data contains the array of seller details
                                    ...
                                    <div className="login_wrap widget-taber-content background-white">
                                        <div className="padding_eight_all bg-white">
                                            ...
                                            <form method="post" onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-group">
                                                    <input required="" type="number" name="Material_sell_price" placeholder="Material selling price" onChange={(e) => setMaterialprice(e.target.value)} />
                                                </div>
                                                <div className="form-group">
