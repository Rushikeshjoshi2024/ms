...
function Sellers_home_scr() {
    ...
    return (
        <div>
            ...
            <div classNameName="section-title wow animate__animated animate__fadeIn">
                <section className="seller-grid-section  pb-5">
                    <div className="container-fluid-lg">
                        <div classNameName="section-title style-2 wow animate__animated animate__fadeIn">
                            <h3>Our Sellers</h3>
                            <ul classNameName="nav nav-tabs links" id="myTab" role="tablist">
                                <li classNameName="nav-item" role="presentation">
                                    <Link classNameName='btn btn-xs'
                                        to={{
                                            pathname: `/Sellers`,
                                            // your data array of objects
                                        }}
                                    >
                                        <button classNameName="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="true">All</button>
                                    </Link>
                                </li>
                            </ul>
                        </div>
